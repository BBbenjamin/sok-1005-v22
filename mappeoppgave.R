...
#geom_textbox(data = "UAH Satellite-Based Temprature of the Global Lower Atmosphere (version 6.0)", nugde_x = 0, nugde_y = 0, col = "white")   
...
ultimate_data %>% 
  ggplot(aes(colour = Level, x = moyear)) +
